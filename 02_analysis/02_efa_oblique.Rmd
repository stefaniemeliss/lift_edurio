...
## Maximum number of years (2018/19 - 2023/24) 

```{r prep_2018, echo = F, fig.align='center', results='asis'}
items <- items_2018
...
```{r efa_2018, echo = F, fig.align='center'}
...
```{r load_2018, echo = F, results='asis', fig.align='center', warning=FALSE}
...
## Maximum number of years (2018/19 - 2023/24) + q_beh_01 - q_sup_02

```{r prep_fin, echo = F, fig.align='center', results='asis'}
...
```{r efa_fin, echo = F, fig.align='center'}
# run chunk to run efa
<<efa>>
```
...
```{r load_fin, echo = F, results='asis', fig.align='center', warning=FALSE}
# run chunk to export loadings
<<load>>
